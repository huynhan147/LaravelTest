...
//        return $test;
       $test = DB::select(DB::raw("select date_part('year',created_at) as year,MONTH(created_at) as month, count(*) published from  posts group by year, month order by min(created_at) desc"));
        return $test;
