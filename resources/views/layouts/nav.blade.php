<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 d-flex justify-content-end align-items-center">
            @if(Auth::check())
                <a class="btn btn-sm btn-outline-secondary mx-1" href="/logout">Log out</a>
                <a class="btn btn-sm btn-outline-secondary mx-1" href="/admins/post/create">Create Post</a>
            @else
